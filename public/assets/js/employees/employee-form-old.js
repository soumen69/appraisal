const EmployeeForm = {
    ...
    populateForm(employee) {
        ...
        this.setSelectValue('#organization_id', employee.organization_id);
        this.loadBranches(employee.organization_id, employee.branch_id);
        this.loadDepartments(employee.organization_id, employee.department_id);
        this.loadDesignations(employee.organization_id, employee.designation_id);
        this.loadRoles(employee.role_id || null);
